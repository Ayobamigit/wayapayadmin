...
import { revenueStats, settlementTransactions, transactionStats } from '../../plugins/urls'
                    ...
                    <tbody>
                    {
                        transactions?
                            ...
                            transactions.map((transaction, i)=>{
                                const{referenceID, beneficiary, actualAmount, settledAmount, createdAt, status} = transaction;
                                const statusClass = () =>{
                                    if(status){
